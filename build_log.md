...
- **Sjednocení designu milníků**: Grafický styl milníků z detailu zakázky (čtvercové boxy s barevným pozadím dle stavu: Zelená=Hotovo, Červená=Zpožděno, Bílá=Čeká) byl přenesen i na **hlavní časovou osu**. Barva všech ikon milníků byla na žádost uživatele nastavena na **fixní černou** pro lepší kontrast a jednotný vzhled.

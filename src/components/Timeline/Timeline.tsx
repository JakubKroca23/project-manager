...
const Hiab = ({ size = 24, color }: any) => {
    // Two-tone version: 
    // - Black/Gray framing and structure (#030303, #A6A7A7, #262727, #868587, #020202)
    // - Dynamic 'color' for the elephant glyph (originally white parts)
    return (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: size, height: size }}>
            <svg version="1.1" viewBox="0 0 756 719" width={size} height={size}>
                {/* Frame/Base Structure (Always dark/black/gray palette) */}
                ...
                {/* DYNAMIC Glyphs (The parts that change color) */}
